...
// ... (implementation for other priority queue operations)
...
int main() {
    char data[] = "this is an example string";  // Input data
    ...
    // Create Huffman tree
    struct Node* root = createHuffmanTree(data, freq, MAX_CHARS);
